                                    ...
                                    <div class="flex max-w-md mx-auto justify-between h-full flex-col items-end gap-14 w-full ">
                                        <div class="gap-10 flex flex-col w-full">
                                            <div class="grid md:grid-cols-4 md:max-w-full max-w-xs mx-auto flex-col gap-5 w-full">
                                                <select name="day" type="number" class="outline-none  !border-zinc-200 focus:outline-orange-400 outline-offset-2 !border md:text-xl text-lg text-center  !p-5 focus:border-zinc-800 !rounded-[20px] w-full" required="">
                                                ...
                                                <div class="w-full md:col-span-2"><select name="month" type="number" class="outline-none  !border-zinc-200 focus:outline-orange-400 outline-offset-2 !border md:text-xl text-lg text-center  !p-5 focus:border-zinc-800 !rounded-[20px] w-full" required="">
                                                    ...
                                                    </select></div><select name="year" type="number" class="outline-none  !border-zinc-200 focus:outline-orange-400 outline-offset-2 !border  text-base text-center  !p-5 focus:border-zinc-800 !rounded-[20px] w-full" required="">
