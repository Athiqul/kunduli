...
//Age 
$year = date('Y');
$userAge = abs($year - $_SESSION['year']);
// Year Month 
$month = date('m');
$userMonth = abs($month - $_SESSION['month']);
//Year date
$date = date('d');
$userDay = abs($date - $_SESSION['day']);
                        ...
                        <div class=" h-full overflow-y-scroll overflow-x-hidden w-full">
                            <?php if ($lan == 'hi') : ?>
                                <div class="w-full h-full" style="opacity:1; transform: scale(1);">
                                    <div class="h-full w-full bg-green-700 items-center justify-center flex flex-col gap-10 pt-2 pb-28">
                                        <div class="flex flex-col justify-between gap-10 px-5">
                                            <div class="flex w-full flex-col justify-center items-center text-center">
                                                <h2 class="md:text-2xl text-2xl font-linotte_bold mb-3 text-white">संख्याओं से उम्र, सितारों से जीवन</h2>
                                            </div>
                                            <div class="bg-white max-w-sm w-full mx-auto rounded-[30px] grid grid-cols-3 gap-5 p-5">
                                                <h2 class="text-lg text-center !font-cera_bold font-linotte_bold col-span-3">
                                                    आपने सूरज का चक्कर <?= $userAge ?> साल, <?= $userMonth ?> महीने, और <?= $userDay ?> दिन तक लगाया है, जैसे तारे आकाश में होते हैं वैसे ही आपने क्षणों का संग्रह किया है।
                                                </h2>
                                                <div class="p-2 bg-yellow-500 text-yellow-500 rounded-full">
                                                    <div class="flex font-linotte_bold flex-col items-center rounded-full bg-white px-2 py-5">
                                                        <span class="text-current"><?= $userAge ?></span><span class="text-sm text-current">साल</span>
                                                    </div>
                                                </div>
                                                <div class="p-2 bg-orange-500 text-orange-500 rounded-full">
                                                    <div class="flex font-linotte_bold flex-col items-center rounded-full bg-white px-2 py-5">
                                                        <span class="text-current"><?= $userMonth ?></span><span class="text-sm text-current">महीने</span>
                                                    </div>
                                                </div>
                                                <div class="p-2 bg-blue-500 text-blue-500 rounded-full">
                                                    <div class="flex font-linotte_bold flex-col items-center rounded-full bg-white px-2 py-5">
                                                        <span class="text-current"><?= $userDay ?></span><span class="text-sm text-current">दिन</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="flex flex-col gap-3 text-center px-5">
                                                <p class="text-base text-zinc-100" style="line-height: 1.5;">क्या आप उत्सुक हैं यह जानने के लिए कि आपके लिए सितारे कैसे संरेखित होते हैं?</p>
                                                <p class="text-base text-zinc-100" style="line-height: 1.5;">अपने व्यक्तिगत ब्रह्मांड की ज्योतिषीय कहानियों को जानने के लिए 'अगला' पर क्लिक करें।</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class=" h-full w-full bg-green-700 items-center justify-center flex flex-col gap-10 pt-2 pb-28">
                                        <div class="flex flex-col justify-between gap-10 px-5">
                                            ...
                                            <div class="bg-white max-w-sm w-full mx-auto rounded-[30px] grid grid-cols-3 gap-5 p-5">
                                                ...
                                                <div class="p-2 bg-yellow-500 text-yellow-500 rounded-full">
                                                    <div class="flex font-linotte_bold flex-col items-center rounded-full bg-white  px-2 py-5">
                                                        <span class="text-current"><?= $userAge ?></span><span class="text-sm text-current">Years</span>
                                                    </div>
                                                </div>
                                                <div class="p-2 bg-orange-500 text-orange-500 rounded-full">
                                                    <div class="flex font-linotte_bold flex-col items-center rounded-full bg-white  px-2 py-5">
                                                        <span class="text-current"><?= $userMonth ?></span><span class="text-sm text-current">Months</span>
                                                    </div>
                                                </div>
                                                <div class="p-2 bg-blue-500 text-blue-500 rounded-full">
                                                    <div class="flex font-linotte_bold flex-col items-center rounded-full bg-white  px-2 py-5">
                                                        <span class="text-current"><?= $userDay ?></span><span class="text-sm text-current">Days</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="flex flex-col gap-3 text-center px-5">
