                                    ...
                                    <div class="h-full w-full">
                                        <div class="w-full md:pb-28 overflow-hidden">
                                            <div class="flex flex-col w-full px-5">
                                                <h2 class="md:text-2xl text-2xl font-linotte_bold mb-5">नमस्ते <?= $_SESSION['name'] ?>,</h2>
                                                <div class="flex gap-3 md:gap-5 flex-col">
                                                    <p class="text-base undefined" style="line-height: 1.5;">हमने आपकी जानकारी देखी। आपकी कुंडली विशेष है, आपकी कुंडली अद्वितीय है। हमने आपके लिए एक विस्तृत कुंडली विश्लेषण रिपोर्ट बनाई है।</p>
                                                    <p class="text-base undefined" style="line-height: 1.5;">हमने आपके बारे में एक विशेष निःशुल्क रिपोर्ट तैयार की है। 30 से अधिक सरल पृष्ठों में, आप सीखेंगे:</p>
                                                    <ul class="ml-5 list-disc font-semibold">
                                                        <li>आपकी कुंडली की नींव - पंचांग</li>
                                                        <li>कुंडली में आपके तीन मुख्य तत्व</li>
                                                        <li>आपका संग्रहीत कर्म</li>
                                                        <li>आपका तत्व संतुलन</li>
                                                        <li>आपकी आत्मा की इच्छा - आत्मा कारक</li>
                                                        <li>आपका अनुकूल देवता (इष्ट देवता)</li>
                                                        <li>आपकी कुंडली में शुभ और अशुभ ग्रह</li>
                                                        <li>आपकी विस्तृत ग्रह प्रोफाइल</li>
                                                        <li>आपकी वर्तमान चल रही दशा</li>
                                                        <li>और भी बहुत कुछ ...</li>
                                                    </ul>
                                                    <p class="text-base undefined" style="line-height: 1.5;">हमारी रिपोर्ट आपको स्वयं को बेहतर ढंग से समझने और अच्छे निर्णय लेने में मदद करती है। इस ज्ञान के बिना, आप व्यक्तिगत विकास के लिए महत्वपूर्ण अंतर्दृष्टियों से चूक सकते हैं।</p>
                                                    <p class="text-base undefined" style="line-height: 1.5;">शुरू करने के लिए 'अगला' पर क्लिक करें</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="flex w-full z-[10] md:max-w-[600px] max-w-2xl left-1/2 -translate-x-1/2 justify-between gap-5 fixed md:bottom-[25px] bottom-3">
                        ...
                        <div class="flex justify-between py-3 px-5 w-[95%] rounded-md mx-auto bg-white shadow shadow-zinc-300/50">
                            <a href="/" class=" max-w-max flex-row-reverse gap-5 justify-between font-cera_regular border border-current opacity-70 text-zinc-500 text-base w-full py-2 px-3 hover:opacity-100 ease-in duration-100 rounded-md flex items-center text-center"><span class="text-current"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    ...
                                    </svg></span></a><a href="/user-report-age" class=" max-w-max relative z-[999] gap-10 justify-between font-cera_regular bg-orange-400 active:bg-orange-800 text-white text-base w-full py-2.5 px-5 ease-in duration-100 rounded-md flex items-center text-center"><span>Next</span><span class="text-current"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
